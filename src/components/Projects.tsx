              ...
              <TiltCard>
                <div className="relative min-h-[22rem] h-auto w-full rounded-3xl overflow-hidden bg-white/[0.02] border border-white/5 backdrop-blur-sm transition-all duration-700 hover:bg-gradient-to-br hover:from-fuchsia-900/40 hover:to-indigo-900/20 hover:border-fuchsia-500/30 hover:shadow-[0_0_50px_rgba(217,70,239,0.15)] flex">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-between p-6 md:p-8 z-10">
                    <p className="text-white/5 text-6xl md:text-7xl font-black tracking-tighter transition-all duration-500 group-hover:text-fuchsia-500/30 group-hover:translate-x-2">{exp.number}</p>
                    <div>
                        <p className="text-fuchsia-400 mb-2 uppercase tracking-[0.2em] text-[10px] md:text-xs font-bold transition-all duration-500 group-hover:tracking-[0.3em]">{exp.category}</p>
                        <h3 className="text-3xl font-extrabold text-white mb-3 transition-transform duration-300 group-hover:-translate-y-1 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-rose-200 group-hover:to-indigo-200 text-balance">
                            {exp.title}
                        </h3>
