    ...
    <section id="about" className="relative z-20 w-full bg-[#0a0a0a] py-40 px-8 md:px-24 overflow-hidden section-optimize">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
        ...
        >
          ...
          <Typewriter text={"Engineering Digital\nExcellence."} delay={0.3} className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-b from-white to-white/60 leading-tight mb-8" />
          <p className="text-xl text-white/70 leading-relaxed font-light mb-8 mt-4 text-justify">
          ...
          <p className="text-xl text-white/70 leading-relaxed font-light mb-12 text-justify">
